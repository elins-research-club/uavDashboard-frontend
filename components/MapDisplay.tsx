    ...
    return (
      <div className="relative h-full w-full overflow-hidden bg-[#eef2ec]">
        ...
        >
          ...
          {spatialInfo?.has_spatial_geometry && spatialInfo.area_hectares && (
            ...
            >
              <img
                src="/postgis.png"
                alt="PostGIS Elephant"
                className="h-3 w-3 shrink-0 object-contain sm:h-3.5 sm:w-3.5 md:h-4 md:w-4"
              />
        ...
        {postgisCardOpen && spatialInfo && (
          <div className="absolute left-1/2 top-14 z-50 w-[calc(100%-20px)] max-w-[400px] -translate-x-1/2 rounded-xl border border-emerald-900/10 bg-white/95 p-3 shadow-2xl backdrop-blur-xl transition-all duration-200 animate-in fade-in slide-in-from-top-2 sm:top-16 sm:w-[92vw] sm:rounded-2xl sm:p-4">
            {/* HEADER */}
            ...
            <div className="my-2 flex items-center gap-1.5 rounded-lg border border-emerald-100/80 bg-emerald-50/70 px-2 py-1.5 text-[9px] text-emerald-900 sm:my-2.5 sm:gap-2 sm:rounded-xl sm:px-3 sm:py-2 sm:text-[11px]">
              <Info className="h-3 w-3 shrink-0 text-emerald-600 sm:h-3.5 sm:w-3.5" />
