  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-10 w-72 h-72 bg-cyan-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center relative z-10">
            ...
            <div className="space-y-5">
              ...
              {message && (
                <div
                  ...
                  } border px-4 py-3 rounded-xl text-sm flex items-start gap-2`}
                >
                  {isSuccess && (
        ...
        <div className="hidden lg:block lg:order-1">
          ...
          <p className="text-xl text-gray-600 mb-8">
            ...
            platform kami untuk pemetaan UAV yang lebih efisien.
          </p>
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900">Setup Cepat</p>
                <p className="text-gray-600 text-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900">Komunitas Aktif</p>
                <p className="text-gray-600 text-sm">
                  Dukungan dari 10,000+ pengguna
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 p-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl border border-blue-100">
            <p className="text-sm text-gray-600 mb-2">Dipercaya oleh</p>
            <p className="text-2xl font-bold text-gray-900">
              10,000+ Profesional
            </p>
            <p className="text-sm text-gray-600 mt-1">dari berbagai industri</p>
          </div>
        </div>
      </div>
    </div>
